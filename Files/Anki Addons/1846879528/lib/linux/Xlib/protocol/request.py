...
class GetWindowAttributes(rq.ReplyRequest):
    _request = rq.Struct(
        rq.Opcode(3), rq.Pad(1), rq.RequestLength(), rq.Window("window")
    )
...
class DestroyWindow(rq.Request):
    _request = rq.Struct(
        rq.Opcode(4), rq.Pad(1), rq.RequestLength(), rq.Window("window")
    )


class DestroySubWindows(rq.Request):
    _request = rq.Struct(
        rq.Opcode(5), rq.Pad(1), rq.RequestLength(), rq.Window("window")
    )
...
class MapWindow(rq.Request):
    _request = rq.Struct(
        rq.Opcode(8), rq.Pad(1), rq.RequestLength(), rq.Window("window")
    )


class MapSubwindows(rq.Request):
    _request = rq.Struct(
        rq.Opcode(9), rq.Pad(1), rq.RequestLength(), rq.Window("window")
    )


class UnmapWindow(rq.Request):
    _request = rq.Struct(
        rq.Opcode(10), rq.Pad(1), rq.RequestLength(), rq.Window("window")
    )


class UnmapSubwindows(rq.Request):
    _request = rq.Struct(
        rq.Opcode(11), rq.Pad(1), rq.RequestLength(), rq.Window("window")
    )
...
class ConfigureWindow(rq.Request):
    _request = rq.Struct(
        ...
        rq.ValueList(
            ...
            rq.Window("sibling"),
            rq.Set(
                "stack_mode", 1, (X.Above, X.Below, X.TopIf, X.BottomIf, X.Opposite)
            ),
        ),
    )
...
class GetGeometry(rq.ReplyRequest):
    _request = rq.Struct(
        rq.Opcode(14), rq.Pad(1), rq.RequestLength(), rq.Drawable("drawable")
    )
...
class QueryTree(rq.ReplyRequest):
    _request = rq.Struct(
        rq.Opcode(15), rq.Pad(1), rq.RequestLength(), rq.Window("window")
    )
...
class GetAtomName(rq.ReplyRequest):
    _request = rq.Struct(
        rq.Opcode(17), rq.Pad(1), rq.RequestLength(), rq.Card32("atom")
    )
...
class ListProperties(rq.ReplyRequest):
    _request = rq.Struct(
        rq.Opcode(21), rq.Pad(1), rq.RequestLength(), rq.Window("window")
    )
...
class GetSelectionOwner(rq.ReplyRequest):
    _request = rq.Struct(
        rq.Opcode(23), rq.Pad(1), rq.RequestLength(), rq.Card32("selection")
    )
...
class UngrabPointer(rq.Request):
    _request = rq.Struct(
        rq.Opcode(27), rq.Pad(1), rq.RequestLength(), rq.Card32("time")
    )
...
class UngrabKeyboard(rq.Request):
    _request = rq.Struct(
        rq.Opcode(32), rq.Pad(1), rq.RequestLength(), rq.Card32("time")
    )
...
class QueryPointer(rq.ReplyRequest):
    _request = rq.Struct(
        rq.Opcode(38), rq.Pad(1), rq.RequestLength(), rq.Window("window")
    )
...
class SetInputFocus(rq.Request):
    _request = rq.Struct(
        rq.Opcode(42),
        rq.Set(
            "revert_to", 1, (X.RevertToNone, X.RevertToPointerRoot, X.RevertToParent)
        ),
        rq.RequestLength(),
        rq.Window("focus"),
        rq.Card32("time"),
...
class QueryFont(rq.ReplyRequest):
    _request = rq.Struct(
        rq.Opcode(47), rq.Pad(1), rq.RequestLength(), rq.Fontable("font")
    )
...
class FreePixmap(rq.Request):
    _request = rq.Struct(
        rq.Opcode(54), rq.Pad(1), rq.RequestLength(), rq.Pixmap("pixmap")
    )
...
class FreeColormap(rq.Request):
    _request = rq.Struct(
        rq.Opcode(79), rq.Pad(1), rq.RequestLength(), rq.Colormap("cmap")
    )
...
class InstallColormap(rq.Request):
    _request = rq.Struct(
        rq.Opcode(81), rq.Pad(1), rq.RequestLength(), rq.Colormap("cmap")
    )


class UninstallColormap(rq.Request):
    _request = rq.Struct(
        rq.Opcode(82), rq.Pad(1), rq.RequestLength(), rq.Colormap("cmap")
    )


class ListInstalledColormaps(rq.ReplyRequest):
    _request = rq.Struct(
        rq.Opcode(83), rq.Pad(1), rq.RequestLength(), rq.Window("window")
    )
...
class FreeCursor(rq.Request):
    _request = rq.Struct(
        rq.Opcode(95), rq.Pad(1), rq.RequestLength(), rq.Cursor("cursor")
    )
    ...
    _request = rq.Struct(
        ...
        rq.ValueList(
            ...
            rq.Set(
                "auto_repeat_mode",
                1,
                (X.AutoRepeatModeOff, X.AutoRepeatModeOn, X.AutoRepeatModeDefault),
            ),
        ),
    )
...
class KillClient(rq.Request):
    _request = rq.Struct(
        rq.Opcode(113), rq.Pad(1), rq.RequestLength(), rq.Resource("resource")
    )
